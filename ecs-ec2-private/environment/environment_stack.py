...
class EnvironmentStack(core.Stack):
    ...
    def cluster_creation(self, name_extension, conf, stage):
        ...
        self.services_sg.add_ingress_rule(_ec2.Peer.ipv4("0.0.0.0/0"), _ec2.Port.tcp(4369), "allow epmd access from anywhere")
        self.services_sg.add_ingress_rule(_ec2.Peer.ipv4("0.0.0.0/0"), _ec2.Port.tcp(25672), "allow epmd access from anywhere")
